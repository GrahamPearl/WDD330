...
let link = 'https://grahampearl.github.io/CSE-121B-JS/portfolio/data/registra.json';
...
const searchByLine = () => {
    ...
    let filter = document.querySelector('#filterLine').value;        
    output(studentList.filter( item => (item['Line'] === parseInt(filter)) ));
}
...
document.querySelector('#filterLine').addEventListener('change', searchByLine);
